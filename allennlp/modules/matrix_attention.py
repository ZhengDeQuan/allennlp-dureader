...
from allennlp.modules.similarity_functions import DotProductSimilarity, SimilarityFunction,MyLinearSimilarity
...
class MatrixAttention(torch.nn.Module):
    ...
    def forward(self, matrix_1: torch.Tensor, matrix_2: torch.Tensor) -> torch.Tensor:
        ...
        if isinstance(self._similarity_function, MyLinearSimilarity):
            return self._similarity_function(matrix_1, matrix_2)
